...
#
# The REST surface is declared via grst.route options in the .proto and
# generated by protoc-gen-fiber (see cmd/protoc-gen-fiber). We build that plugin
# into ./bin first, then run `buf generate` which invokes protoc-gen-go,
# protoc-gen-go-grpc, and protoc-gen-fiber (per buf.gen.yaml).
proto:
